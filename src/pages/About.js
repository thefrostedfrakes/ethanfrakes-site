  ...
  return (
    <main className="site-content">
      ...
      <div className="text-box">
        <p>
          I am a PhD student at the University of Central Florida's School of Modeling, Simulation and Training. Previously, I received my B.S. degree in Computer Science, also from UCF.
          ...
          Currently, I'm working at UCF's Spatiotemporal AI & Graphs for Energy (SAGE) Lab.
